...
public class IssueHistoryActivity extends AppCompatActivity {
    ...
    private final String METHOD_NAME = "GetIssueList";
       ...
       // defaultList();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(IssueHistoryActivity.this,MainActivity.class));
                finish();
            }
        });
                ...
                if (!resp.get("data").isEmpty()) {
                    ...
                    for(int i=0; i< resp.get("data").size();i++)
                    {
                        ...
                        myList.add(new HistoryModel(resp.get("data").get(i).getVisitId(),resp.get("data").get(i).getParty(),
                                ...
                                resp.get("data").get(i).getCheckOutTime(),resp.get("data").get(i).getComments(),"issueHistory"));
                    }
                    ...
                    loadingProgressBar.setVisibility(View.GONE);
                    head.showAlertDialog(IssueHistoryActivity.this, " Empty Value", "Oops !!!", false);
                }
            }else {
                loadingProgressBar.setVisibility(View.GONE);
                head.showAlertDialog(IssueHistoryActivity.this," Empty Value", "Oops !!!", false);
